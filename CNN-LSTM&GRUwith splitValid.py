...
encoder_bilstm = LSTM(latent_dim, return_sequences=True)(maxpooling_layer)
...
# Train the model
model.fit([train_data_en,train_data_ar],train_data_ar, validation_data=([valid_data_en,valid_data_ar],valid_data_ar),batch_size=64, epochs=30)
...
output_file = "D:/PHD Papers/scientific translation/GPT/BiLSTM witth Attention/NewDataset/Results/LSTM-GRUEng-Arb2.txt"
